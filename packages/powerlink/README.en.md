# POWERLINK 协议包 — 需 openPOWERLINK/B&R Automation Studio 桥接

> [中文](README.md)

erikwang2013/industrial-protocols-powerlink — Bridge implementation, category: Hardware-Dependent (Bridge).

## Installation

```bash
composer require erikwang2013/industrial-protocols-kernel erikwang2013/industrial-protocols-powerlink
```
