# IO-Link 协议包 — 需 ifm/Balluff IO-Link Master 桥接

> [中文](README.md)

erikwang2013/industrial-protocols-iolink — Bridge implementation, category: Hardware-Dependent (Bridge).

## Installation

```bash
composer require erikwang2013/industrial-protocols-kernel erikwang2013/industrial-protocols-iolink
```
