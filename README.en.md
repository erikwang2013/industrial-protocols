# PCI/PCIe 协议包 — 系统总线，需内核驱动/库桥接

> [中文](README.md)

erikwang2013/industrial-protocols-pci — Bridge implementation, category: Hardware-Dependent (Bridge).

## Installation

```bash
composer require erikwang2013/industrial-protocols-kernel erikwang2013/industrial-protocols-pci
```
